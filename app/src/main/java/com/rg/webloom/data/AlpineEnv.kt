...
object AlpineEnv {
    ...
    private const val B_FUNCTION =
        "# >>> LIGHTBROWSER-B (managed — do not edit) >>>\n" +
            ...
            "    reload-hard) _b_get '/reload-hard';;\n" +
            "    ua) _b_get '/ua' --data-urlencode \"op=\${1:-get}\" --data-urlencode \"value=\$2\";;\n" +
            "    viewport) _b_get '/viewport';;\n" +
            "    zoom) _b_get '/zoom' --data-urlencode \"op=\${1:-get}\";;\n" +
            "    netlog) _b_get '/netlog' --data-urlencode \"max=\${1:-50}\";;\n" +
            "    clear-data) _b_get '/clear-data' --data-urlencode \"what=\${1:-all}\";;\n" +
            "    tabdup) _b_get '/tabdup';;\n" +
            "    shot-el) _b_get '/shot-el' --data-urlencode \"sel=\$1\";;\n" +
            "    scroll-top) _b_get '/scrollto' --data-urlencode 'x=0' --data-urlencode 'y=0';;\n" +
            "    scroll-bottom) _b_get '/scrollto' --data-urlencode 'x=0' --data-urlencode 'y=999999';;\n" +
            ...
            "    circle) _b_get '/circle' --data-urlencode \"cx=\$1\" --data-urlencode \"cy=\$2\" --data-urlencode \"r=\$3\" --data-urlencode \"n=\${4:-28}\";;\n" +
            "    scribble|doodle) _b_get '/gesture' --data-urlencode \"path=\$1,\$2 \$3,\$4\" --data-urlencode \"seed=\";;\n" +
            "    gesture|stroke) _b_get '/gesture' --data-urlencode \"path=\$1\" --data-urlencode \"ms=\${2:-600}\";;\n" +
            "    scroll) _b_get '/scroll' --data-urlencode \"y=\${1:-500}\";;\n" +
            "    scrollto) _b_get '/scrollto' --data-urlencode \"x=\${1:-0}\" --data-urlencode \"y=\${2:-0}\";;\n" +
            "    block|unblock) echo 'EXEC-only: run b block/unblock in EXEC mode (privacy control)';;\n" +
            "    blocks) _b_get '/block';;\n" +
