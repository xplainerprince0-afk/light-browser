...
import com.rg.webloom.ui.browser.BrowserScreen
import com.rg.webloom.ui.browser.BrowserViewModel
import com.rg.webloom.ui.downloads.DownloadsScreen
import com.rg.webloom.ui.files.FilesScreen
import com.rg.webloom.ui.music.MusicScreen
import com.rg.webloom.ui.music.MusicViewModel
import com.rg.webloom.ui.scripts.ScriptsScreen
import com.rg.webloom.ui.settings.SettingsScreen
import com.rg.webloom.ui.terminal.TerminalScreen
import com.rg.webloom.ui.theme.LightBrowserTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        // The bottom bar stays docked at the physical bottom: the keyboard
        // overlays it instead of pushing it up.
        try {
            androidx.core.view.WindowCompat.setDecorFitsSystemWindows(window, false)
        } catch (_: Exception) {}
        try { AppCtx.init(this) } catch (_: Exception) {}
        try { AppTabs.edgeSwipe = Prefs.edgeSwipe } catch (_: Exception) {}
        try { com.rg.webloom.ui.settings.applyLang(this, try { Prefs.appLang } catch (_: Exception) { "system" }) } catch (_: Exception) {}
        ...
        try {
            androidx.core.view.ViewCompat.setOnApplyWindowInsetsListener(decor) { _, insets ->
                try {
                    ...
                    com.rg.webloom.ui.terminal.InsetDebug.kbHeightPx.intValue = maxOf(ime, frameKb)
                    com.rg.webloom.ui.terminal.InsetDebug.sysNavPx.intValue = nav
        ...
        setContent {
            ...
            LightBrowserTheme(darkTheme = dark, blackTheme = black && dark) {
                ...
                SideEffect {
                    try { com.rg.webloom.ui.terminal.InsetDebug.composeImePx.intValue = imeTopPx } catch (_: Exception) {}
                }
    ...
    private fun hideKeyboard() {
        try {
            ...
            // Hide IME but keep View focus: clearing focus forces the PTY
            // TerminalView to lose its input connection, so the next tap
            // needs two presses and the keyboard looks "auto-cancelled".
            currentFocus?.let {
...
private fun AppShell(
    ...
    ModalNavigationDrawer(
        ...
        // Drawer gesture stays off: it overlapped browser gestures.
        ...
        Scaffold(
            ...
            SideEffect {
                try {
                    com.rg.webloom.ui.terminal.InsetDebug.outerPadPx =
                        ...
                        Box(modifier = Modifier.fillMaxSize()) {
                            ...
                            EdgeTabStrip(
                                ...
                                onLongPress = if (tab == Tab.Terminal) {
                                    { com.rg.webloom.ui.terminal.InsetDebug.drawerAsk++ }
                                } else null,
                                dragEnabled = edgeOn,
    ...
    if (showAbout) {
        androidx.compose.material3.AlertDialog(
            ...
            title = { Text("Webloom 4.0") },
            text = { Text("v${try { com.rg.webloom.BuildConfig.VERSION_NAME } catch (_: Exception) { "?" }} (${try { com.rg.webloom.BuildConfig.VERSION_CODE } catch (_: Exception) { "?" }})\n\nBrowser · Sandbox · Terminal (Alpine) · Player\n\nCompose + Material 3 Expressive · ExoPlayer") },
            confirmButton = {
