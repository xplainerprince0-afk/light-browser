package com.rg.webloom.ui.settings
...
import com.rg.webloom.data.Backup
        ...
        item {
            SettingsCard(title = "Navigation") {
                SwitchRow(label = "Edge swipe switches tabs", checked = edgeSwipe, onChange = {
                    ...
                    try { com.rg.webloom.AppTabs.edgeSwipe = it } catch (_: Exception) {}
                    Toast.makeText(
                        ctx,
                            ...
                            try {
                                when (flow) {
                                    ...
                                    "prefs" -> {
                                        ...
                                        try { com.rg.webloom.AppTabs.edgeSwipe = false } catch (_: Exception) {}
                                        edgeSwipe = false
                                        termScale = 1f
                                        playerSpeed = 1f
