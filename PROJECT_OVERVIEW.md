...
- [x] Terminal: `b` tab/cookies-set-clear/history/downloads/submit/read/shot-full/hover/select/store-named/mkext-script (EXEC+PTY HTTP routes, measured keyboard lift)
